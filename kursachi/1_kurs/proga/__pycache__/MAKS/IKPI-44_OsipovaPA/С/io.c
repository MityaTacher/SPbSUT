...
void print_parametr()
{
    ...
    printf("Input signal pulse width: %.7f\nOutput signal pulse width: %.7f",
           get_impuls_lenght(N, Uvx_array),
           get_impuls_lenght(N, Uvix_array));
}
